...
[pscustomobject]@{
    ...
    attach_popup_prevention = 'normal_bridge_debugger_permission_scoped_to_cdpInput_hover_tap_active_drag_viewportEmulation_deviceEmulation_geolocationEmulation_localeEmulation_and_mediaEmulation_inactive_synthetic_drag_no_helper_windows_no_nativeMessaging_permission_plus_external_popup_risk_suppression'
