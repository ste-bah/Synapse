...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-18-popup-free-tabs-v3'
    bridge_build_sha256_expected = 'd24f1d218007f4db52b08bfe8d0b3b838e105593b7f6424b169b11d416c3b49b'
