...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-21-dispatch-event-v1'
    bridge_build_sha256_expected = '6927167c6562db4dc9f09d659b14e14b9331b3cf6e1cd476302a3a5b58869b33'
