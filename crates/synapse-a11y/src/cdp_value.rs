...
/// `rename` attributes.
pub(crate) fn cdp_enum_str<T: Serialize>(value: &T) -> String {
...
pub(crate) fn cdp_number_f64<T: Serialize>(value: &T) -> Option<f64> {
    serde_json::to_value(value)
        .ok()
...
pub(crate) fn cdp_number_f64_or_zero<T: Serialize>(value: &T) -> f64 {
