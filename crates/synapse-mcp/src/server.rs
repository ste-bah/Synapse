...
use crate::{
    ...
    m1::{
        ...
        BrowserLocateParams, BrowserLocateResponse, BrowserLocatedFrame, BrowserNetworkWaitEntry,
        BrowserPdfParams, BrowserPdfResponse, BrowserScreenshotParams, BrowserScreenshotResponse,
        ...
        BrowserWaitForLoadStateParams, BrowserWaitForLoadStateResponse,
        ...
        ReadTextParams, SetCaptureTargetParams, SetCaptureTargetResponse, SetPerceptionModeParams,
